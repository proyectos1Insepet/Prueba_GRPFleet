...
//            flujo_LCD1 = 11;             
        ...
        case 1:
         if(LCD_1_GetRxBufferSize()==8){ 
             ...
             set_imagen(1,46);				//Muestra imagen de inicio GRP700
	         flujo_LCD1 = 20;	         
             LCD_1_ClearRxBuffer();	
             seleccion_pos = 0;
         }
        ...
        case 9:
            ...
            if(seleccion_pos == 2){
                ...
                if(ppux10==1){
        			rf_mod[25]=(lado1.ppu[rventa2.manguera-1][3]&0x0F)+0x30;		//PPUx10
        			rf_mod[26]=(lado1.ppu[rventa2.manguera-1][2]&0x0F)+0x30;
        			rf_mod[27]=(lado1.ppu[rventa2.manguera-1][1]&0x0F)+0x30;
        			rf_mod[28]=(lado1.ppu[rventa2.manguera-1][0]&0x0F)+0x30;
        			rf_mod[29]=0x30;   
                }
        ...
        case 11:    
            ...
            if(seleccion_pos == 2){
                if(touch_present(1)==1){
                    if(touch_write(1,0x33)){
    	                for(x=0;x<=7;x++){
    	                    rventa2.id[x]=touch_read_byte(1);
    	                }
    				    crc_total=0;
    				    for(x=0;x<7;x++){
        ...
        if(seleccion_pos == 2){
            ...
            PC_ClearTxBuffer();				
            estado_tanqueando=0;				
			precio[0]=lado1.ppu[rventa2.producto-1][0];
			precio[1]=lado1.ppu[rventa2.producto-1][1];
        ...
        case 14:
	        if(LCD_1_GetRxBufferSize()==8){
	            ...
	            CyDelay(100);            //Caso 14 sin segunda posición
	            LCD_1_ClearRxBuffer();
	        }         			
		break;
