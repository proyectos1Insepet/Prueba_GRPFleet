...
#define Psoc_IntClock_SetDivider(clkDivider)         Psoc_IntClock_SetDividerRegister(clkDivider, 1)
#define Psoc_IntClock_SetDividerValue(clkDivider)    Psoc_IntClock_SetDividerRegister((clkDivider) - 1, 1)
...
#define Psoc_IntClock_SetPhaseValue(clkPhase)        Psoc_IntClock_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(Psoc_IntClock__CFG3) */
