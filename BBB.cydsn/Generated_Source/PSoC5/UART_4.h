...
#define UART_4_TXBUFFERSIZE                   (4u)
#define UART_4_RXBUFFERSIZE                   (4u)
...
#define UART_4_BIT_CENTER                         (UART_4_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 UART_4_initVar;
    ...
    extern volatile uint8 UART_4_txBuffer[UART_4_TXBUFFERSIZE];
    extern volatile uint8 UART_4_txBufferRead;
    extern uint8 UART_4_txBufferWrite;
#endif /* End UART_4_TX_ENABLED */
#if( ( UART_4_RX_ENABLED || UART_4_HD_ENABLED ) && \
     (UART_4_RXBUFFERSIZE > UART_4_FIFO_LENGTH) )
    extern volatile uint8 UART_4_rxBuffer[UART_4_RXBUFFERSIZE];
...
#if (UART_4_RXHW_ADDRESS_ENABLED)
    #define UART_4_RXADDRESSMODE      (0u)
    #define UART_4_RXHWADDRESS1       (0u)
    #define UART_4_RXHWADDRESS2       (0u)
